...
namespace AIManager_namespace
{
    ...
    public abstract class AIManager : CharacterManager
    {
        ...
        protected override void Initialized()
        {
            ...
            m_currentIndexOfGivenPath = Random.Range(0, m_FollowPath.pathTransformPosition.Length);
            ...
            m_unwareTime = Random.Range(m_MinMaxUnwareTime.MinValue, m_MinMaxUnwareTime.MaxValue);
            m_patrolTime = Random.Range(m_MinMaxPatrolTime.MinValue, m_MinMaxPatrolTime.MaxValue);
        }
        ...
        public void FollowAlongNavMeshPath(NavMeshPath navmeshPath, Vector3 opponetPosition, bool manuallyControlRotation = false)
        {
            ...
            {
                Vector3 directionToOpponenet = opponetPosition - transform.position;
        ...
        private void ControlRotation(Vector3 directionOfRotation)
        {
        ...
        private void ControlRotationAnimation(float angle)
        {
